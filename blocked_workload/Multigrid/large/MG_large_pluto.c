...
static void smooth_gs_inplace(double u[N][N], double f[N][N], int sweeps)
{
  for (int s = 0; s < sweeps; ++s) {
    for (int bi = 0; bi < (N + 8 - 1) / 8; ++bi) {
      for (int bj = 0; bj < (N + 8 - 1) / 8; ++bj) {
#pragma scop
        ...
        for (int ii = 0; ii < 256; ++ii) {
          for (int jj = 0; jj < 256; ++jj) {
            if (bi * 256 + ii > 0 &&
                ...
                bi * 256 + ii < N - 1 &&
                bj * 256 + jj < N - 1) {
              r[bi * 256 + ii][bj * 256 + jj] =
                  f[bi * 256 + ii][bj * 256 + jj] +
                  u[bi * 256 + ii - 1][bj * 256 + jj] +
                  u[bi * 256 + ii + 1][bj * 256 + jj] +
                  u[bi * 256 + ii][bj * 256 + jj - 1] +
                  u[bi * 256 + ii][bj * 256 + jj + 1] -
                  4.0 * u[bi * 256 + ii][bj * 256 + jj];
            }
          }
        }
#pragma endscop
        ...
        for (int ii = 0; ii < 32; ++ii) {
          for (int jj = 0; jj < 32; ++jj) {
            if (bI * 32 + ii > 0 &&
                ...
                bI * 32 + ii < NC - 1 &&
                bJ * 32 + jj < NC - 1) {
              f_c[bI * 32 + ii][bJ * 32 + jj] =
                  (4.0 * r_f[2 * (bI * 32 + ii)][2 * (bJ * 32 + jj)] +
                   2.0 * (r_f[2 * (bI * 32 + ii) - 1][2 * (bJ * 32 + jj)] +
                          r_f[2 * (bI * 32 + ii) + 1][2 * (bJ * 32 + jj)] +
                          r_f[2 * (bI * 32 + ii)][2 * (bJ * 32 + jj) - 1] +
                          r_f[2 * (bI * 32 + ii)][2 * (bJ * 32 + jj) + 1]) +
                   (r_f[2 * (bI * 32 + ii) - 1][2 * (bJ * 32 + jj) - 1] +
                    r_f[2 * (bI * 32 + ii) - 1][2 * (bJ * 32 + jj) + 1] +
                    r_f[2 * (bI * 32 + ii) + 1][2 * (bJ * 32 + jj) - 1] +
                    r_f[2 * (bI * 32 + ii) + 1][2 * (bJ * 32 + jj) + 1])) *
                  (1.0 / 16.0);
...
#pragma scop
        for (int ii = 0; ii < 128; ++ii) {
          for (int jj = 0; jj < 128; ++jj) {
            if (bI * 128 + ii > 0 &&
                ...
                bI * 128 + ii < NC &&
                bJ * 128 + jj < NC) {
              u[2 * (bI * 128 + ii)][2 * (bJ * 128 + jj)] +=
                  e_c[bI * 128 + ii][bJ * 128 + jj];
            }
          }
        }
        ...
        for (int ii = 0; ii < 128; ++ii) {
          for (int jj = 0; jj < 128; ++jj) {
            if (bI * 128 + ii + 1 < NC &&
                bJ * 128 + jj > 0 &&
                bJ * 128 + jj < NC) {
              u[2 * (bI * 128 + ii) + 1][2 * (bJ * 128 + jj)] +=
                  0.5 * (e_c[bI * 128 + ii][bJ * 128 + jj] +
                         e_c[bI * 128 + ii + 1][bJ * 128 + jj]);
            }
          }
        }
        ...
        for (int ii = 0; ii < 128; ++ii) {
          for (int jj = 0; jj < 128; ++jj) {
            if (bJ * 128 + jj + 1 < NC &&
                bI * 128 + ii > 0 &&
                bI * 128 + ii < NC) {
              u[2 * (bI * 128 + ii)][2 * (bJ * 128 + jj) + 1] +=
                  0.5 * (e_c[bI * 128 + ii][bJ * 128 + jj] +
                         e_c[bI * 128 + ii][bJ * 128 + jj + 1]);
            }
          }
        }
        ...
        for (int ii = 0; ii < 128; ++ii) {
          for (int jj = 0; jj < 128; ++jj) {
            if (bI * 128 + ii + 1 < NC &&
                bJ * 128 + jj + 1 < NC) {
              u[2 * (bI * 128 + ii) + 1][2 * (bJ * 128 + jj) + 1] +=
                  0.25 * (e_c[bI * 128 + ii][bJ * 128 + jj] +
                          e_c[bI * 128 + ii + 1][bJ * 128 + jj] +
                          e_c[bI * 128 + ii][bJ * 128 + jj + 1] +
                          e_c[bI * 128 + ii + 1][bJ * 128 + jj + 1]);
            }
          }
        }
#pragma endscop
